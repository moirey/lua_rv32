...
local exec_OP_M = {
  ...
  [OP_M.REM] = function(cpu, inst)
                  ...
                  if divisor == 0 then cpu.regs[ R_func[FUNC.rd](inst) ] = dividend end
                  if divisor == -1 and dividend == -2147483648 then cpu.regs[ R_func[FUNC.rd](inst) ] = 0 end
                  cpu.regs[ R_func[FUNC.rd](inst) ] = dividend % divisor
                end,
